...
output "github_actions_ecr_role_arn" {
  description = "IAM role ARN for GitHub Actions OIDC — add as AWS_ACTIONS_ROLE_ARN secret in the production environment (github.com/YOUR_GITHUB_USERNAME/clearledger/settings/environments)"
